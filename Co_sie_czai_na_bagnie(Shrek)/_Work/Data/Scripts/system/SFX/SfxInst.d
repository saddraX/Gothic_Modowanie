...
/* Orc */
				...
				INSTANCE ORC_Attack						(C_SFX_DEF) {file= "ORC_Attack01.wav";				vol = 127;			};
				INSTANCE ORC_Attack_A1					(C_SFX_DEF) {file= "ORC_Attack02.wav";				vol = 127;			};				
				INSTANCE ORC_Die						(C_SFX_DEF) {file= "ORC_Die01.wav";					vol = 127;			};
				INSTANCE ORC_Frightened					(C_SFX_DEF) {file= "ORC_Frightened01.wav";			vol = 127;			};
				INSTANCE ORC_Happy						(C_SFX_DEF) {file= "ORC_Happy01.wav";				vol = 127;			};
				INSTANCE ORC_Hurt						(C_SFX_DEF) {file= "ORC_Hurt01.wav";				vol = 127;			};
				INSTANCE ORC_Hurt_A1					(C_SFX_DEF) {file= "ORC_Hurt02.wav";				vol = 127;			};
				INSTANCE ORC_Warn						(C_SFX_DEF) {file= "ORC_Warn01.wav";				vol = 127;			};
				INSTANCE ORC_Ambient_Short				(C_SFX_DEF) {file= "ORC_Ambient_Short01.wav";		vol = 100;			};
				INSTANCE ORC_Ambient_Short_A1			(C_SFX_DEF) {file= "ORC_Ambient_Short02.wav";		vol = 100;			};
				INSTANCE ORC_Ambient_Short_A2			(C_SFX_DEF) {file= "ORC_Ambient_Short03.wav";		vol = 100;			};
				INSTANCE ORC_Ambient_Short_A3			(C_SFX_DEF) {file= "ORC_Ambient_Short04.wav";		vol = 100;			};
